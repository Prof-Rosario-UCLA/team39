...
const role_message = `You are a model that is knowledgable about every country in the world. 
You generate interesting trivia facts about countries for use in a country guessing game`;
...
// Write to file
await writeFile("requests.jsonl-v1", lines.join("\n"));
